...
This is the standalone version of the renderer from `t1/conversation_image_renderer.py`.
The default config intentionally preserves the original compact image settings:
512px width, max 512px height, font size 10.
"""
